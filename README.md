...
| 方向 | 类型 | 说明 |
| :---: | :---: | :---: |
| 客户端 -> 服务端 | LOGIN\|昵称 | 登录请求，昵称为用户输入的聊天名称 |
| 服务端 -> 客户端 | OK | 登录成功确认 |
| 服务端 -> 客户端 | ERR\|错误描述 | 登录失败或其他错误，错误描述说明具体原因 |
| 服务端 -> 客户端 | MSG\|发送者昵称\|消息内容 | 群聊消息广播，所有在线用户都能收到 |
| 服务端 -> 客户端 | PRIVATE\|发送者昵称\|消息内容 | 私聊消息，仅发送者和接收者可见 |
| 服务端 -> 客户端 | USERS\|昵称1,昵称2,... | 当前在线用户列表，昵称间用逗号分隔 |
| 服务端 -> 客户端 | JOINED\|昵称 | 新用户上线通知 |
| 服务端 -> 客户端 | LEFT\|昵称 | 用户下线通知 |
| 客户端 -> 服务端 | QUIT | 客户端主动断开连接 |
| 客户端 -> 服务端 | PING | 心跳检测请求 |
| 服务端 -> 客户端 | PONG | 心跳检测回复 |
